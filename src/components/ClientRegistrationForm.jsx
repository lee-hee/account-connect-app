...
import { ChevronRight, ChevronLeft, User, Home, Briefcase, CheckCircle } from 'lucide-react';
...
const ClientRegistrationForm = () => {
  ...
  const steps = [
    ...
    { number: 2, title: 'Address & Residency', icon: Home },
    { number: 3, title: 'Family Details', icon: User },
    { number: 4, title: 'Business Entities', icon: Briefcase }
  ];

  const handleNext = () => {
    if (validateStep(currentStep, formData, setErrors) && currentStep < 4) {
