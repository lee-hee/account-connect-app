...
const ClientRegistrationForm = ({ userData, onRegistrationComplete, onLogout }) => {
  ...
  const handleNext = async () => {
    ...
    if (saveResult.success) {
      ...
      // If this is step 2 (Financial Details), store the banking info
      if (currentStep === 2 && saveResult.bankingInfo) {
        console.log(`🏦 Banking Info received:`, saveResult.bankingInfo);
        setFormData(prev => ({
          ...prev,
          primaryBankingInfoId: saveResult.bankingInfo.bankingInfoId,
          bankingInfo: saveResult.bankingInfo
        }));
      }
